...
def get_imgs_fn(file_name, mode  = 'RGB', channel_idx = {0, 1, 2}):

	img = scipy.misc.imread(file_name, False, mode)
	data = np.zeros( (img.shape[0], img.shape[1], len(channel_idx)), dtype=np.float32 )
	ci:int = 0
